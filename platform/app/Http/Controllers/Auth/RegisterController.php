    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('dashboard')
            ->with('status', $status === 'verified'
                ? 'Welcome! Your charity has been verified. Please confirm your email address.'
                : 'Application received. We\'ll review and verify your organisation within 24 hours.'
            );
    }
