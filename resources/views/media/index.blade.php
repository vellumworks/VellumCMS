...
<style>
    ...
    .media-actions { opacity: 0; transition: opacity 0.15s; }
</style>
@endsection
...
@if ($media->isEmpty())
    <div class="text-center py-24 bg-white rounded-2xl border border-dashed border-gray-300">
        <svg class="h-12 w-12 text-gray-300 mx-auto mb-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909M3.75 21h16.5M13.5 3.75h3.75m0 0v3.75m0-3.75L21 7.5"/>
        </svg>
...
@else
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        <div class="media-card relative bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden group">
            ...
            {{-- Hover actions --}}
            <div class="media-actions absolute inset-0 bg-black/50 flex flex-col items-center justify-center gap-2 p-2">
                <button type="button"
                ...
                <form method="POST" action="{{ route('media.destroy', $file) }}"
                    ...
                    @csrf @method('DELETE')
                    <button class="w-full bg-red-500 text-white text-xs font-semibold py-1.5 rounded-lg hover:bg-red-600 transition px-3">
                        Delete
                    </button>
                </form>
                @endif
