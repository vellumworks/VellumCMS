...
<section class="bg-[#0f172a] text-white py-24 px-6 text-center relative overflow-hidden">
    <div class="max-w-4xl mx-auto relative z-10">
        ...
        <p class="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-10">VellumCMS isn’t just open-source — it’s open-hearted. Created for charities, activists, and everyday revolutionaries who build for impact, not profit.</p>
        <a href="/get-started" class="bg-white text-[#0f172a] px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition">Join the Builders</a>
    </div>
...
<section class="py-20 px-6 bg-white">
    <div class="max-w-5xl mx-auto text-center">
        <h2 class="text-3xl font-bold mb-4">This Isn’t a CMS. It’s a Stand.</h2>
...
<section class="relative bg-[#F9FAFB] py-32 px-6 overflow-hidden">
    <div class="max-w-5xl mx-auto">
        <h2 class="text-5xl font-bold text-gray-900 leading-tight mb-16">What’s Under the Hood<br><span class="text-gray-500 text-2xl block mt-2 font-light">Built with intent. Tuned for trust.</span></h2>
